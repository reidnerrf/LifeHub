...
const NotesView: React.FC = () => {
  ...
  const [notes, setNotes] = useState([
    ...
    },
    {
      ...
      content: 'Leite, pão, ovos, frutas, arroz integral, azeite, queijo, iorgurte natural.',
      type: 'text',
    ...
    },
    {
      ...
      content: 'Atomic Habits, Mindset, The Lean Startup, Clean Code, Thinking Fast and Slow.',
      type: 'text',
